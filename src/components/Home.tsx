...
const handleResume = () => {
  window.open("https://drive.google.com/file/d/1QWcM-U3ULtDzlvp4xLVoStbGnPdDAZUu/view?usp=sharing", "_blank");
};
    ...
    <div>
      <div className="mt-[16%] ml-10 md:mt-[10%] md:ml-[15%] lg:mt-[10%]  lg:ml-[15%]">
        ...
        <p className="text-lg mt- leading-relaxed mr-2 md:mr-[45%] md:text-xl  xl:mr-[50%]">
          ...
          <RoughNotation show={true} animate={true} type="highlight" color="#8394e7" animationDelay={1000} animationDuration={500}>
            interfaces,
          </RoughNotation>
          {""}
          <br />
          ...
          <div className="mt-[20%] md:flex md:mt-[10%]">
            ...
            <div className="mt-5 mr-6 text-left md:mt-0 md:ml-[10%] md:mr-[20%] lg:mr-[20%] lg:ml-[5%] xl:mr-[10%]">
              <p className="md:inline-block">
                ...
                <RoughNotation show={true} animate={true} type="highlight" color="#CCC8AA" animationDelay={1400} animationDuration={800}>
                  scalable
                </RoughNotation>{" "}
                and{" "}
                <RoughNotation show={true} animate={true} type="highlight" color="#6b6fdb" animationDelay={1400} animationDuration={800}>
                  efficient,
                </RoughNotation>{" "}
                ensuring a seamless user experience.I'm well-versed in{" "}
                <RoughNotation show={true} animate={true} type="highlight" color="#F4E869" animationDelay={1400} animationDuration={800}>
                  front-end,
                </RoughNotation>{" "}
                and{" "}
                <RoughNotation show={true} animate={true} type="highlight" color="#E5C3A6  " animationDelay={1400} animationDuration={800}>
                  <span> backend</span>{" "}
                </RoughNotation>{" "}
                development, ready to tackle new challenges and make meaningful contributions to your team. Excited about the opportunities ahead!
                <br />
                <br />
                I'm, currently looking for a role as a developer.
                <RoughNotation show={true} animate={true} type="circle" color="#12486B" animationDelay={1000} animationDuration={500} strokeWidth={1}>
                  <span className="font-semibold">Hire me. </span>
                </RoughNotation>
                <span className="block mt-3 cursor-pointer underline decoration-sky-500 decoration-4" onClick={handleResume}>
